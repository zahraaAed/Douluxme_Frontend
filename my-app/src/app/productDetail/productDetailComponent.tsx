    ...
    try {
      await axios.post(
        "https://douluxme-backend.onrender.com/api/feedbacks/create",
        {
          comment: newComment,
          ProductId: Number(id),
          // Don't send UserId, the backend will get it from the auth token
        },
        {
            ...
            <div className="flex justify-between items-center my-6">
              ...
              <button
                ...
                className={`px-6 py-2 rounded-md font-semibold ${
                  user ? "bg-[#808000] text-white hover:bg-[#E67300]" : "bg-gray-300 text-gray-700 hover:bg-gray-400"
                }`}
              >
                        ...
                        <div
                          ...
                          className={`w-full max-w-md aspect-[4/3] flex flex-col justify-center p-6 ${
                            idx % 2 === 0
                              ...
                              : "bg-[#808000] border-0" // Right card: green background, no border
                          }`}
                        >
                          <p
          ...
          {user ? (
            <div className="mt-8 flex flex-col items-center">
              ...
              <button
                ...
                className="bg-[#808000] text-white px-6 py-2 rounded-md font-semibold"
              >
                Submit Feedback
              </button>
            </div>
